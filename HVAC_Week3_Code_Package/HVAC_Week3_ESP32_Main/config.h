...
// =============================================================
//  PROJECT: Smart Ventilation & HVAC - Week 3 Prototype
//  BOARD  : ESP32 DevKit
...
static constexpr bool ENABLE_WIFI_AP = true;
static constexpr bool ENABLE_WIFI_STA = false;
static constexpr bool ENABLE_LOCAL_HTTP_COMMANDS = true;
static constexpr bool ENABLE_CLOUD_UPLOAD = false;  // keep false for week 3 unless backend is ready

static const char* AP_SSID = "HVAC_WEEK3";
static const char* AP_PASSWORD = "12345678";  // at least 8 chars

// If ENABLE_WIFI_STA=true, fill your router Wi-Fi here.
