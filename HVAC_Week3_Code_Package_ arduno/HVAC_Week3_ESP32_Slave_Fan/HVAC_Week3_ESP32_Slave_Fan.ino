...
// =============================================================
//  ESP32 SLAVE 1 - Ventilation Fan / Relay prototype
//  Main ESP32 SoftAP: 192.168.4.1
//  This slave static IP: 192.168.4.2
// =============================================================
...
void handleRoot() {
  String msg = "ESP32 Slave Fan OK. Current state: ";
...
void setup() {
  ...
  Serial.println();
  Serial.print("Slave Fan IP: "); Serial.println(WiFi.localIP());
